...
export type TokenSource = "env:GITHUB_TOKEN" | "file" | "gh-cli";
 ...
 *   1. GITHUB_TOKEN env (from .env or the shell)
 *   2. STRAPPY_HOME/secrets/github-token (written by `strappy auth`)
